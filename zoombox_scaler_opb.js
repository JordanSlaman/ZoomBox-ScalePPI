                    //console.log($(this).data("scalefactor"));
                    //console.log(this.getAttribute("data-scalefactor"));
...
var options = {
    theme       : 'scale-custom',      //available themes : zoombox,lightbox, prettyphoto, darkprettyphoto, simple
...
/**
* fix this so no duplication, regex/concatenation
**/
...
var html_scaler = '<div id="zoombox"> \
                <div class="zoombox_mask"></div>\
                <div class="zoombox_container">\
                    <div class="zoombox_content"></div>\
                    <div class="zoombox_title"></div>\
...
var html_ccModal_en = '<!-- Credit Card Calibration Modal English -->\
            <div class="modal fade ccmodal" id="creditCardModal" tabindex="-1" role="dialog" aria-labelledby="Credit Card Calibration" data-backdrop="false">\
              <div class="modal-dialog modal-lg" role="document">\
                <div class="modal-content">\
                  <div class="modal-header">\
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>\
                    <h4 class="modal-title" id="Calibration">Credit Card Calibration</h4>\
                  </div>\
                  <div class="modal-body" id="creditCardBody">\
                    <div class="row">\
                        <ol>\
                          <li>Place a real card over the card on your screen.</li>\
                          <li>Select the lower right corner and resize the card on your screen to match the size of your real card. Try to be as precise has possible.</li>\
                          <li>Click on the save button and move to the next step.</li>\
                        </ol>\
                    </div>\
                      <div id="flex"></div>\
                  </div>\
                  <div class="modal-footer">\
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal" id="ccSave">Save</button>\
                  </div>\
                </div>\
              </div>\
            </div>';

var html_ccModal_fr = '<!-- Credit Card Calibration Modal French -->\
            <div class="modal fade ccmodal" id="creditCardModal" tabindex="-1" role="dialog" aria-labelledby="Credit Card Calibration" data-backdrop="false">\
              <div class="modal-dialog modal-lg" role="document">\
                <div class="modal-content">\
                  <div class="modal-header">\
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>\
                    <h4 class="modal-title" id="Calibration">Calibration avec carte de crédit</h4>\
                  </div>\
                  <div class="modal-body" id="creditCardBody">\
                    <div class="row">\
                        <ol>\
...
function build(){
    ...
    if(options.display_scaler) {
        if(options.french_modals) {
            ...
            $('.zoombox_scale_toggled').prop('title', 'Désactiver la grandeur réelle');

            $(function () {
              $('[data-toggle="tooltip"]').tooltip()
            });
        } else {
            $('body').append(html_ccModal_en);
    ...
    //Calibrate button behaviour
    $('#zoombox .zoombox_calibrate').click(function(){
        calibrate();
        return false;
    });
...
function open(){
    ...
    if (resizeScaled) {
        ...
        $( "#scaleToggle" ).removeClass( "zoombox_scale" );
        
    } else {
        $( "#scaleToggle" ).addClass( "zoombox_scale" );
        $( "#scaleToggle" ).removeClass( "zoombox_scale_toggled" );
    }
